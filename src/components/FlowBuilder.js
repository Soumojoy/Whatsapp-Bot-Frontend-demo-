...
const styles = {
  ...
  flowTitle: { margin: 0, fontSize: '15px', color: '#1a1a2e' },
  flowType: {
    fontSize: '11px',
    padding: '2px 8px',
    borderRadius: '4px',
  ...
  flowReply: { marginLeft: '40px' },
  replyLabel: { fontSize: '12px', color: '#888', fontWeight: '600' },
  replyValue: {
    margin: '2px 0 0',
    fontSize: '13px',
    color: '#555',
  ...
  formTitle: { margin: '0 0 16px', fontSize: '16px', color: '#1a1a2e' },
  ...
  chatText: { margin: '0 0 4px', fontSize: '14px' },
  chatOption: { margin: '2px 0', fontSize: '14px' },
};
