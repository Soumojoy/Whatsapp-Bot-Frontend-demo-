...
const styles = {
  ...
  headerTitle: { margin: 0, fontSize: '22px', fontWeight: '800', color: '#1a1a2e', letterSpacing: '-0.3px' },
  main: { maxWidth: '1200px', margin: '0 auto', padding: '36px 32px' },
  twoCol: { display: 'flex', gap: '28px', flexWrap: 'wrap' },
  leftCol: { flex: '1', minWidth: '340px', display: 'flex', flexDirection: 'column', gap: '20px' },
  ...
  cardTitle: { margin: 0, fontSize: '17px', fontWeight: '700', color: '#1a1a2e' },
  editBtn: {
    padding: '7px 18px',
    borderRadius: '8px',
